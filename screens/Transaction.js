...
export default class TransactionScreen extends Component {
  ...
  handleTransaction = async() => {
    ...
    //Desafio 01: Chamar a função que verifica a disponibilidade do livro no BD 
    ...
    db.collection("books")
      ...
      .then(doc => {
        ...
        //Desafio 02: Condição para análise SE transactionType é false

        if (book.is_book_available) {
          var {bookName, studentName} = this.state;
          this.initiateBookIssue(bookId,studentId,bookName, studentName);
          Alert.alert("Livro emprestado para o aluno!");
        } else {
          var {bookName, studentName} = this.state;
